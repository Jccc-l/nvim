...
vim.keymap.set('n', 'grt', vim.lsp.buf.type_definition, vim.tbl_extend('force', opts, { desc = 'LSP: Go to type definition' }))

-- Implementation: Jumps to the implementation of the interface/symbol
vim.keymap.set('n', 'gri', vim.lsp.buf.implementation, vim.tbl_extend('force', opts, { desc = 'LSP: Go to implementation' }))
...
vim.keymap.set({'n', 'x'}, 'gra', vim.lsp.buf.code_action, vim.tbl_extend('force', opts, { desc = 'LSP: Code action' }))
